...
%%  ******************************************************  %%
%%                                                          %%
%% Chapter 4: Fig 4.18 & 4.19                               %%
%%                                                          %%
%% Author: Frank Gross                                      %%
%% McGraw-Hill, 2005                                        %%
%% Date:  4/24/2005                                         %%
%%                                                          %%
%% This code creates Figures 4.18 & 4.19, plots of Gaussian %%
...
if check == 0
    ...
    title('\bfFigure 4.18 - Gaussian Array Weights vs. Element Number')
    axis([1 N 0 1.1])
    AF = 0;
    tot = sum(wB);
    for i = 1:N/2
...
title('\bfFigure 4.19 -  Gaussian Weighted Array Factor vs. Angle')

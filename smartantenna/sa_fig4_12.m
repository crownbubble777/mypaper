...
%%  ******************************************************  %%
%%                                                          %%
%% Chapter 4: Fig 4.12 & 4.13                               %%
%%                                                          %%
%% Author: Frank Gross                                      %%
%% McGraw-Hill, 2005                                        %%
%% Date:  4/24/2005                                         %%
%%                                                          %%
%% This code creates Figures 4.12 & 4.13, plots of binomial %%
...
if check == 0    % If the array is even
    ...
    title('\bfFigure 4.12 - Binomial Array Weights vs. Element Number')
    axis([1 N 0 1.1])
    AF = 0;
    tot = sum(wB);
    for i = 1:N/2
...
title('\bfFigure 4.13 - Binomial Weighted Array Factor vs. Angle')

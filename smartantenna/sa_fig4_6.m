...
%% Date:  9/6/2004                                          %%
%%                                                          %%
%% This code creates Fig 4.6, a polar plot of a 4 element   %%
%%     End-Fire Array with delta = -kd and d = 0.25lambda,  %% 
...
title('\bf\itFigure 4.6 - Array Factor Plots of 4 Element End-Fire Array for d/\lambda = 0.25, 0.5, 0.75')

...
%% Date:  1/26/2004                                        %%
%%                                                         %%
%% This code creates Figure 7.7, plot of a Min - Norm      %%
...
grid on
title(['\bfFigure 7.7 - Min - Norm Psuedospectra for \theta = +/- 5^o'])
xlabel('Angle')
ylabel('|P(\theta)|')
axis([-30 30 -30 10])